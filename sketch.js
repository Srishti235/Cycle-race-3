...
function preload(){
  ...
  oppPink1Img = loadImage("images/opponent1.png","images/opponent2.png");
  oppPink2Img = loadImage("images/opponent3.png");
  
  oppYellow1Img = loadImage("images/opponent4.png","images/opponent5.png");
...
mainCyclist  = createSprite(100,height-20);
...
function draw() {
  ...
  restart.visible = false;
   ...
   mainCyclist.y = touches.length>0;
